            ...
            <div class="col-md-6 col-sm-7">
                <div class="single-product-image-inner">
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane active" id="one" style="width: 90%; margin-bottom: 30px; position: relative">
                            ...
                            <div style="width: 15%; z-index: 999; position: absolute; top:0;right: 0">
                                ...
                                <p style="font-size:20px;position: absolute;left: 50%; top: 55%; transform: translate(-50%, -50%);color: white;">
                                    <%=sach.getKhuyenMai()%>%</p>
                            </div>
                            <%}%>
                        </div>
            ...
            <div class="col-md-6 col-sm-5">
                <div class="single-product-details">
                    ...
                    <div class="single-product-price">
                        <% if (sach.getKhuyenMai() > 0) { %>
                        <h2><%= sach.tienKhuyenMai()%>.000đ</h2>
                        <span style="color: black; font-size: 18px" class="old-price"><%= sach.getGia()%>.000đ</span>
                        <%} else {%>
                    ...
                    <div class="add-to-wishlist">
                        <a class="wish-btn" href="<%=Util.fullPath("ThemVaoWishListController?maSach=" + sach.getMaSach())%>">
                    ...
                    <div class="tab-content review">
                        ...
                        <div role="tabpanel" class="tab-pane" id="data">
                            <table class="table-data-sheet">
                                ...
                                <tr class="even">
                                    <td>Thể loại</td>
                                    <td><%=sach.getTenLoaiSach()%></td>
                                </tr>
                                <tr class="odd">
                                    <td>Tên tác giả</td>
                                    <td><%=sach.getTenTacGia()%></td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
