                                        ...
                                        <div class="order-history">
                                            ...
                                            <div class="progress" style="width: 85%; margin: auto;">
                                                <div
                                                        ...
                                                        aria-valuemin="0"
                                                        aria-valuemax="100"
                                                        <%if (listBill.get(i).getTinhTrangBill() == 1) {%>
                                                        style="width: 10%"
                                                        <%} else if (listBill.get(i).getTinhTrangBill() == 2) {%>
                                                        style="width: 25%"
                                                        <%} else if (listBill.get(i).getTinhTrangBill() == 3) {%>
                                                        style="width: 50%"
                                                        <%} else if (listBill.get(i).getTinhTrangBill() == 4) {%>
                                                        style="width: 75%"
                                                        <%} else if (listBill.get(i).getTinhTrangBill() == 5) {%>
                                                        style="width: 100%"
                                                        <%}%>
                                            ...
                                            <div style="display: flex; justify-content: space-between; margin-bottom: 20px; font-size: 14px; text-align: center; width: 100%; margin: auto;">
                                                <p style="background-color: transparent; color: black">Đặt hàng thành
                                                    công</p>
                                                ...
                                                <p style="background-color: transparent; color: black">Bàn giao vận
                                                    chuyển</p>
                                                <p style="background-color: transparent; color: black">Giao hàng thành
                                                    công</p>
                                            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="create-account-button pull-left">
                    <a href="IndexController" class="btn button button-small" title="Home">
								<span>
