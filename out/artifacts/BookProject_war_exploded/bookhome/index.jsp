                        ...
                        <div class="single-p-banner">
                            <div class="col-md-3">
                                <div class="single-banner">
                                    ...
                                    <% if (listSachMoiNhat.get(i).getKhuyenMai() > 0) { %>
                                    <div style="width: 15%; z-index: 999; position: absolute; top:0;right: 0">
                                        ...
                                        <p style="font-size:14px;position: absolute;left: 15%; top: 55%; transform: translate(0, -50%);color: white;">
                                            <%=listSachMoiNhat.get(i).getKhuyenMai()%>%</p>
                                    </div>
                                    <div class="banner-bottom text-center">
                                        ...
                                        <div style="color: #32b5f3" class="price-2"><%=listSachMoiNhat.get(i).tienKhuyenMai()%>.000đ
                                            <span style="color: black" class="old-price"><%=listSachMoiNhat.get(i).getGia()%>.000đ</span>
                                        </div>
                                    </div>
                                    <% } else {%>
                                    <div class="banner-bottom text-center">
                                        ...
                                        <div style="color: #32b5f3" class="price-2"><%=listSachMoiNhat.get(i).getGia()%>.000<span>đ</span>
                                        </div>
                                    </div>
                                    <% }%>
                                </div>
                        ...
                        <div class="single-p-banner">
                            <div class="col-md-3">
                                <div class="single-banner">
                                    ...
                                    <% if (listSachBanChay.get(i).getKhuyenMai() > 0) { %>
                                    <div style="width: 15%; z-index: 999; position: absolute; top:0;right: 0">
                                        <img src=<%=Util.fullPath("bookhome/img/sale.png")%> alt="">
                                        <p style="font-size:14px;position: absolute;left: 15%; top: 55%; transform: translate(0, -50%);color: white;">
                                            <%=listSachBanChay.get(i).getKhuyenMai()%>%</p>
                                    </div>
                                    <div class="banner-bottom text-center">
                                        <div class="banner-bottom-title" style="height: 40px">
                                        ...
                                        <div style="color: #32b5f3" class="price-2"><%=listSachBanChay.get(i).tienKhuyenMai()%>.000đ
                                            <span style="color: black" class="old-price"><%=listSachBanChay.get(i).getGia()%>.000đ</span>
                                        </div>
                                    </div>
                                    <% } else {%>
                                    <div class="banner-bottom text-center">
                                        ...
                                        <div style="color: #32b5f3" class="price-2"><%=listSachBanChay.get(i).getGia()%>.000<span>đ</span>
                                        </div>
                                    </div>
                                    <% }%>
                                </div>
